...
def random_pokemon():
    ...
    return dict(name=pokemon['name'], id=pokemon['id'], height=pokemon['height'], weight=pokemon['weight'], experience=pokemon['base_experience'])

#THIS FUNCTION IS FETCHING A POKEMON BY ITS NAME OR ID NUMBER FROM THE API
...
def game():
    ...
    while user_score < winning_score and computer_score < winning_score:
        ...
        #USER CANNOT ENTER ANOTHER POKEMON NAME AND FETCH ITS DATA
        ...
        #USER PICKS ONE OF THE OPTIONS AND FETCH A RANDOM POKEMON FOR THE COMPUTER
            ...
            print('Your stats are id:{}, weight:{}, height:{}, experience:{}'.format(my_pokemon['id'],my_pokemon['weight'],my_pokemon['height'],my_pokemon['experience']))
            time.sleep(3)
            ...
            choice_list=[opponent_pokemon['id'],opponent_pokemon['height'],opponent_pokemon['weight'],opponent_pokemon['experience']]
            ...
            print('Your opponent has chosen {}, and its value is {}'.format(computer_stat_choice, opponent_pokemon[computer_stat_choice] ))
            time.sleep(3)
            #USER STAT IS HIGHER THAN COMPUTER, USER WINS
            if my_stat > opponent_stat:
                user_score += 1
                print('You Win! Your Score: ', user_score, 'Computer Score: ' , computer_score)
            ...
            #USER STAT IS LESS THAN COMPUTER, COMPUTER WINS
                ...
                computer_score += 1
                print('You Lose! Your Score: ', user_score, 'Computer Score: ' , computer_score)
                print('---')
                time.sleep(2)
            #DRAW
            else:
